...
/**
 * Services liés aux Patient
 */
class Client extends Modele
{
    private $sql = "select   idPatient,  dateCreation,  sexe,  nomPatient,  pernomPatient,  dateNaissancePatient,  adressePatient,  telephonePatient,  emailPatient,  cinPatient,  Allergie,  note,  idVille,  idAssurance from patient";

    /**
     * Vérifie q'un patient existe dans la BD
     * 
     * @param type $courriel
     * @param type $mdp
     * @return type
